...
class CombinedControllerApp(tk.Tk):
    ...
    def _build_axis_table(self, parent: ttk.Frame) -> None:
        ...
        headers = ["Use", "Active", "Controller", "Axis", "Kind", "Position", "Ready/Busy", "Detail Status", "Slow", "Fast", "Rate"]
    ...
    def _build_motion_panel(self, root: ttk.Frame) -> None:
        ...
        buttons = [
            ...
            ("Excitation On", lambda: self.set_excitation_selected(True)),
            ("Excitation Off", lambda: self.set_excitation_selected(False)),
    ...
    def set_excitation_selected(self, enabled: bool) -> None:
        title = "Excitation On" if enabled else "Excitation Off"
        self._send_grouped_commands(
            title,
    ...
    def clear_emergency_selected(self) -> None:
        self._send_grouped_commands(
            "Clear Emergency",
            lambda controller, axes: [command for command in [controller.clear_emergency(axes)] if command],
            refresh_after=True,
            require_ready=False,
        )
